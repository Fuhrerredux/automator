export const commanding: DropdownOption<CommandingRole>[] = [
  { label: 'roles.marshal', value: 'marshal' },
  { label: 'roles.general', value: 'general' },
  { label: 'roles.admiral', value: 'admiral' }
]

export const advisors: DropdownOption<Position>[] = [
